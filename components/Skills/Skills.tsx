...
const skillCategories = [
  {
    ...
    skills: [
      ...
      { name: "Wireshark", icon: <SiWireshark />, level: 75 },
      { name: "Nmap", icon: <FaShieldAlt />, level: 70 },
      { name: "Metasploit", icon: <FaShieldAlt />, level: 65 },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Switching", icon: <FaNetworkWired />, level: 75 },
      { name: "SNMP/Syslog", icon: <FaNetworkWired />, level: 70 },
    ],
  },
];
