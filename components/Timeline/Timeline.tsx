...
const timelineItems = [
  {
    year: "2025",
    type: "Formation",
    title: "Licence Professionnelle — Réseaux & Sécurité",
    institution: "Institut Supérieur",
    description: "Spécialisation en cybersécurité, réseaux avancés et développement de solutions sécurisées.",
    color: "#c8a96e",
  },
  {
    year: "2024",
    type: "Projet",
    title: "Dashboard Réseau Python + Packet Tracer",
    institution: "Projet Personnel",
    description: "Développement d'une application de monitoring réseau complète avec API PT Anywhere, SNMP et Syslog.",
    color: "#6eb5c8",
  },
  {
    year: "2024",
  ...
  },
  {
    year: "2023",
    type: "Projet",
    title: "E-commerce Ninakaire",
    institution: "Projet Académique",
    description: "Conception et développement d'une boutique en ligne complète avec PHP, MySQL et JavaScript.",
    color: "#6ec8a9",
  },
  {
    year: "2023",
    ...
    description: "Formation technique en systèmes informatiques, réseaux et développement logiciel.",
    color: "#a96ec8",
  },
  {
    year: "2022",
